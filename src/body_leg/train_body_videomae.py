"""
train_body_videomae.py
Fine-tunes VideoMAE on full body crops for body track (A1-A5 + no-body).
...
def main():
    ...
    train_ds = BodyCropDataset(args.train_csv, processor, is_train=True)
    val_ds   = BodyCropDataset(args.val_csv,   processor, is_train=False)
