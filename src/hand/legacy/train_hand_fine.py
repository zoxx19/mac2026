...
def train(args):
    ...
    train_ds = HandFineDataset(
        csv_path      = 'data/hand_dataset/hand_fine_train.csv',
        kp_dir        = kp_train,
    ...
    val_ds = HandFineDataset(
        csv_path      = 'data/hand_dataset/hand_fine_val.csv',
        kp_dir        = kp_val,
        joint_indices = list(range(17)),
        augment       = False,
        rgb_augment   = False,
    ...
    # ── Class weights ─────────────────────────────────────────────────────────
    labels  = pd.read_csv('data/hand_dataset/hand_fine_train.csv')['local_label'].values
