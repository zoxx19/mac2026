...
#SBATCH --output=/home/woody/iwso/iwso226h/ma52/logs/eval_head_%j.log
#SBATCH --error=/home/woody/iwso/iwso226h/ma52/logs/eval_head_%j.err
...
$PYTHON src/head/evaluate.py \
    ...
    --model_name /home/woody/iwso/iwso226h/ma52/models/videomae-ssv2 \
    --model_type videomae \
