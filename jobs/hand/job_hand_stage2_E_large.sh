#!/bin/bash -l
#SBATCH --job-name=hs2_E_L
#SBATCH --output=/home/woody/iwso/iwso226h/ma52/logs/hand_stage2_E_large.log
#SBATCH --error=/home/woody/iwso/iwso226h/ma52/logs/hand_stage2_E_large.err
#SBATCH --gres=gpu:1
...
$PYTHON src/hand/train_stage2.py \
    ...
    --output_dir    outputs/hand_stage2_E_large \
