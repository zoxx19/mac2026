#!/bin/bash -l
#SBATCH --job-name=hs2_F_S
#SBATCH --output=/home/woody/iwso/iwso226h/ma52/logs/hand_stage2_F_ssv2_os.log
#SBATCH --error=/home/woody/iwso/iwso226h/ma52/logs/hand_stage2_F_ssv2_os.err
#SBATCH --gres=gpu:1
...
$PYTHON src/hand/train_stage2.py \
    ...
    --output_dir    outputs/hand_stage2_F_ssv2_os \
