#!/bin/bash -l
#SBATCH --job-name=hand_ens
#SBATCH --output=/home/woody/iwso/iwso226h/ma52/logs/hand_eval_ensemble.log
#SBATCH --error=/home/woody/iwso/iwso226h/ma52/logs/hand_eval_ensemble.err
#SBATCH --gres=gpu:1
...
$PYTHON src/hand/evaluate_twostage_ensemble.py \
    ...
    --output_dir       outputs/eval_hand_twostage_ensemble
