#!/bin/bash -l
#SBATCH --job-name=leg_ovs2
#SBATCH --output=/home/woody/iwso/iwso226h/ma52/logs/leg_oversample_ssv2.log
#SBATCH --error=/home/woody/iwso/iwso226h/ma52/logs/leg_oversample_ssv2.err
#SBATCH --gres=gpu:1
...
$PYTHON src/experiments/train_leg_oversample.py \
    ...
    --output_dir outputs/leg_oversample_ssv2 \
