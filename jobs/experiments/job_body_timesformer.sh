#!/bin/bash -l
#SBATCH --job-name=body_tsf
#SBATCH --output=/home/woody/iwso/iwso226h/ma52/logs/body_timesformer.log
#SBATCH --error=/home/woody/iwso/iwso226h/ma52/logs/body_timesformer.err
#SBATCH --gres=gpu:1
...
$PYTHON src/experiments/train_timesformer.py \
    ...
    --num_classes  6 \
    --output_dir   outputs/body_timesformer \
