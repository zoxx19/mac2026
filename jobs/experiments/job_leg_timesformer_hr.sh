#!/bin/bash -l
#SBATCH --job-name=leg_tshr
#SBATCH --output=/home/woody/iwso/iwso226h/ma52/logs/leg_timesformer_hr.log
#SBATCH --error=/home/woody/iwso/iwso226h/ma52/logs/leg_timesformer_hr.err
#SBATCH --gres=gpu:1
...
$PYTHON src/experiments/train_timesformer.py \
    ...
    --label_col    leg_label \
    --num_classes  9 \
    --output_dir   outputs/leg_timesformer_hr \
