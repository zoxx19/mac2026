...
model = dict(
    ...
    rpn_head=dict(
        ...
        label_smoothing=0.1,
        loss=dict(
            cls_loss=dict(type="FocalLoss", weight=[0.4207, 0.6766, 1.1347, 3.0559, 0.8372, 0.4127, 0.6085, 0.2399, 0.1165, 0.135, 0.1816, 0.5559, 0.5141, 0.9498, 1.6384, 1.1072, 1.3673, 0.39, 1.1951, 0.2599, 0.7786, 0.2577, 0.4834, 0.4357, 0.2732, 0.7786, 0.9237, 0.9392, 1.053, 0.5401, 0.4777, 0.5516, 1.3365, 1.3673, 1.5715, 1.8537, 1.9132, 1.1188, 1.1727, 1.3425, 1.4951, 1.0297, 1.4492, 0.9087, 1.4492, 3.3312, 2.1112, 1.3673, 0.4077, 0.2569, 0.9525, 2.2757]),
...
work_dir = "work_dirs/e2e_mma52_videomae_l_adapter"
